...
public class TransactionLinkedList implements TransactionList {
	...
	public TransactionLinkedList(Transaction init) {
		this.firstTransaction = init;
		Transaction current = init;
		while (current.next != null) {
			current = current.next;
			this.transactionQuantity++;
		}
		this.lastTransaction = current;
		this.transactionQuantity++;
	}

	@Override
	public void addTransaction(Transaction transaction) { this.lastTransaction.next = transaction; this.lastTransaction = transaction; this.transactionQuantity++; }
